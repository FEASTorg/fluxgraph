...
void benchmark_json_loader(const std::string &name, const std::string &json,
                           int iterations) {
...
int main() {
  ...
  benchmark_json_loader("Medium graph (100 edges, 10 models)", medium_json,
                        1000);
...
int main() {
  std::cout
      << "JSON loader not enabled. Rebuild with -DFLUXGRAPH_JSON_ENABLED=ON\n";
  return 0;
}
