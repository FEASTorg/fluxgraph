...
TEST_F(ThermalMassTest, InitialTemperature) {
    ThermalMassModel model("test", 1000.0, 10.0, 25.0,
...
TEST_F(ThermalMassTest, HeatingBehavior) {
    ThermalMassModel model("test", 1000.0, 10.0, 20.0,
                          "model/temperature", "model/heating_power", "model/ambient_temp", *ns);
...
TEST_F(ThermalMassTest, CoolingBehavior) {
    ThermalMassModel model("test", 1000.0, 10.0, 100.0,
                          "model/temperature", "model/heating_power", "model/ambient_temp", *ns);
...
TEST_F(ThermalMassTest, Equilibrium) {
    ThermalMassModel model("test", 1000.0, 10.0, 50.0,
                          "model/temperature", "model/heating_power", "model/ambient_temp", *ns);
...
TEST_F(ThermalMassTest, Describe) {
    ThermalMassModel model("chamber_air", 8000.0, 50.0, 25.0,
                          "model/temperature", "model/heating_power", "model/ambient_temp", *ns);
